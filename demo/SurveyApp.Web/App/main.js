...
define(['durandal/app', 'durandal/viewLocator', 'durandal/system', 'durandal/viewEngine',
        'durandal/plugins/router', 'typeMetadata', 'utility/typeMetadataHelper'],
    ...
    app.start().then(function () {
        ...
        //':id' extracts the value and it is passed as an argument into the 'activate'
        ...
        // typeMetadata is a require module defined in Index.cshtml
        // as a result of a C# TypeMetadataHelper.EmitTypeMetadataArray() call
